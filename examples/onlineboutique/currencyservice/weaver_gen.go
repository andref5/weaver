...
func init() {
	codegen.Register(codegen.Registration{
		Name:        "github.com/ServiceWeaver/examples/onlineboutique/currencyservice/T",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, getSupportedCurrenciesMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/examples/onlineboutique/currencyservice/T", Method: "GetSupportedCurrencies"}), convertMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/examples/onlineboutique/currencyservice/T", Method: "Convert"})}
		},
