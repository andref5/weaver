...
func init() {
	codegen.Register(codegen.Registration{
		Name:        "github.com/ServiceWeaver/examples/onlineboutique/shippingservice/T",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, getQuoteMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/examples/onlineboutique/shippingservice/T", Method: "GetQuote"}), shipOrderMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/examples/onlineboutique/shippingservice/T", Method: "ShipOrder"})}
		},
