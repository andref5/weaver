...
func init() {
	codegen.Register(codegen.Registration{
		Name:        "github.com/ServiceWeaver/examples/onlineboutique/emailservice/T",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, sendOrderConfirmationMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/ServiceWeaver/examples/onlineboutique/emailservice/T", Method: "SendOrderConfirmation"})}
		},
